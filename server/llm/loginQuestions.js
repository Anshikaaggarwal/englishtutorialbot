...
if (!GEMINI_API_KEY) {
  console.warn(
    "[loginQuestions] GOOGLE_CLOUD_API_KEY / GOOGLE_API_KEY / GEMINI_API_KEY is not set. " +
      "Login questions will fall back to static defaults."
  );
}
...
const STATIC_QUESTIONS = [
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Fluent and expressive in speaking or writing",
        hindiText: "बोलने या लिखने में प्रवाहमान और अभिव्यक्त",
      },
      {
        id: "b",
        englishText: "Silent and quiet",
        hindiText: "मौन और शांत",
      },
      {
        id: "c",
        englishText: "Angry and aggressive",
        hindiText: "गुस्सैल और आक्रामक",
      },
      {
        id: "d",
        englishText: "Confused and unclear",
        hindiText: "भ्रमित और अस्पष्ट",
      },
    ],
    correctAnswer: "a",
    points: 20,
  },
  {
    id: 2,
    englishQuestion:
      'Complete the sentence: "If I ____ known about the party, I would have gone."',
    hindiQuestion:
      'वाक्य को पूरा करें: "अगर मुझे पार्टी के बारे में ____ होता, तो मैं जाता।"',
    options: [
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Rare and uncommon",
        hindiText: "दुर्लभ और असामान्य",
      },
      {
        id: "b",
        englishText: "Present everywhere",
        hindiText: "हर जगह मौजूद",
      },
      {
        id: "c",
        englishText: "Very large",
        hindiText: "बहुत बड़ा",
      },
      {
        id: "d",
        englishText: "Difficult to understand",
        hindiText: "समझना मुश्किल",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "To work hard",
        hindiText: "कठोर परिश्रम करना",
      },
      {
        id: "b",
        englishText: "To delay or postpone",
        hindiText: "देरी करना या स्थगित करना",
      },
      {
        id: "c",
        englishText: "To plan carefully",
        hindiText: "सावधानी से योजना बनाना",
      },
      {
        id: "d",
        englishText: "To celebrate",
        hindiText: "मनाना",
      },
    ],
    correctAnswer: "b",
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "To make worse",
        hindiText: "बदतर बनाना",
      },
      {
        id: "b",
        englishText: "To improve or make better",
        hindiText: "सुधारना या बेहतर बनाना",
      },
      {
        id: "c",
        englishText: "To remain unchanged",
        hindiText: "अपरिवर्तित रहना",
      },
      {
        id: "d",
        englishText: "To destroy completely",
        hindiText: "पूरी तरह नष्ट करना",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Kind and generous",
        hindiText: "दयालु और उदार",
      },
      {
        id: "b",
        englishText: "Malevolent or wicked",
        hindiText: "दुर्भावनापूर्ण या दुष्ट",
      },
      {
        id: "c",
        englishText: "Neutral and indifferent",
        hindiText: "तटस्थ और उदासीन",
      },
      {
        id: "d",
        englishText: "Shy and quiet",
        hindiText: "शर्मीला और शांत",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Lasting a very short time",
        hindiText: "बहुत कम समय तक चलने वाली",
      },
      {
        id: "b",
        englishText: "Long-lasting and permanent",
        hindiText: "दीर्घकालीन और स्थायी",
      },
      {
        id: "c",
        englishText: "Related to space",
        hindiText: "अंतरिक्ष से संबंधित",
      },
      {
        id: "d",
        englishText: "Extremely complicated",
        hindiText: "अत्यंत जटिल",
      },
    ],
    correctAnswer: "a",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Lazy and idle",
        hindiText: "आलसी और निष्क्रिय",
      },
      {
        id: "b",
        englishText: "Hardworking and careful",
        hindiText: "मेहनती और सावधान",
      },
      {
        id: "c",
        englishText: "Rude and impolite",
        hindiText: "असभ्य और अशिष्ट",
      },
      {
        id: "d",
        englishText: "Confused and lost",
        hindiText: "भ्रमित और खोया हुआ",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Based on practical experience",
        hindiText: "व्यावहारिक अनुभव पर आधारित",
      },
      {
        id: "b",
        englishText: "Related to grammar",
        hindiText: "व्याकरण से संबंधित",
      },
      {
        id: "c",
        englishText: "Completely theoretical",
        hindiText: "पूरी तरह सैद्धांतिक",
      },
      {
        id: "d",
        englishText: "Very romantic",
        hindiText: "बहुत रोमांटिक",
      },
    ],
    correctAnswer: "a",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "To accuse falsely",
        hindiText: "झूठा आरोप लगाना",
      },
      {
        id: "b",
        englishText: "To support or defend successfully",
        hindiText: "सफलतापूर्वक समर्थन या बचाव करना",
      },
      {
        id: "c",
        englishText: "To ignore completely",
        hindiText: "पूरी तरह अनदेखा करना",
      },
      {
        id: "d",
        englishText: "To punish harshly",
        hindiText: "कठोर दंड देना",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Very careless",
        hindiText: "बहुत लापरवाह",
      },
      {
        id: "b",
        englishText: "Extremely careful and precise",
        hindiText: "अत्यंत सावधान और सटीक",
      },
      {
        id: "c",
        englishText: "Somewhat confused",
        hindiText: "थोड़ा भ्रमित",
      },
      {
        id: "d",
        englishText: "Very nervous",
        hindiText: "बहुत घबराया हुआ",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "Related to sweating",
        hindiText: "पसीने से संबंधित",
      },
      {
        id: "b",
        englishText: "Having keen insight or understanding",
        hindiText: "तीव्र अंतर्दृष्टि या समझ रखना",
      },
      {
        id: "c",
        englishText: "Very nervous and anxious",
        hindiText: "बहुत घबराया हुआ और चिंतित",
      },
      {
        id: "d",
        englishText: "Unwilling to listen",
        hindiText: "सुनने के लिए अनिच्छुक",
      },
    ],
    correctAnswer: "b",
    points: 20,
  ...
  },
  {
    ...
    options: [
      {
        id: "a",
        englishText: "To make clear and simple",
        hindiText: "स्पष्ट और सरल बनाना",
      },
      {
        id: "b",
        englishText: "To make obscure or unclear",
        hindiText: "अस्पष्ट या अस्पष्ट बनाना",
      },
      {
        id: "c",
        englishText: "To decorate beautifully",
        hindiText: "सुंदर तरीके से सजाना",
      },
      {
        id: "d",
        englishText: "To organize systematically",
        hindiText: "व्यवस्थित तरीके से संगठित करना",
      },
    ],
    correctAnswer: "b",
    points: 20,
...
function stripCodeFences(text) {
  ...
  if (cleaned.startsWith("```")) {
    ...
    cleaned = cleaned.substring(firstFenceEnd + 1);
...
async function generateLoginQuestionsWithGemini() {
  if (!GEMINI_API_KEY) {
    return STATIC_QUESTIONS;
  }

  const systemInstruction =
    "You are an English placement test generator for Hindi-speaking learners. " +
    "Create exactly 5 multiple-choice questions that help estimate a learner's English level. " +
    "Include both an English question and a Hindi translation. " +
    "Each question must have exactly 4 options, labelled with ids 'a', 'b', 'c', and 'd'. " +
    "Choose one correctAnswer from these ids. " +
    "Set points to 20 for every question so the total is 100.";
  ...
  const userPrompt =
    ...
    '      "options": [\n' +
    '        {"id": "a", "englishText": "string", "hindiText": "string"},\n' +
    '        {"id": "b", "englishText": "string", "hindiText": "string"},\n' +
    '        {"id": "c", "englishText": "string", "hindiText": "string"},\n' +
    '        {"id": "d", "englishText": "string", "hindiText": "string"}\n' +
    "      ],\n" +
    '      "correctAnswer": "a",\n' +
    '      "points": 20\n' +
    "    }\n" +
    "  ]\n" +
    "}\n\n" +
    "Make questions gradually more difficult from beginner to advanced.";
  ...
  try {
    ...
    console.error("[loginQuestions] Gemini generation failed, using static questions:", err.message);
    return STATIC_QUESTIONS;
  }
}

async function getLoginQuestions() {
  // Entry point for Express route
  const questions = await generateLoginQuestionsWithGemini();
  return { questions };
}
